    ...
    <Sidebar className="border-r bg-sidebar">
      <SidebarHeader className="border-b p-6">
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <h1 className="text-xl font-bold text-sidebar-foreground">StartupGPT</h1>
            <p className="text-xs text-sidebar-foreground/60">AI Legal Partner</p>
          </div>
        </div>
      </SidebarHeader>
              ...
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.id}>
                  <SidebarMenuButton
                    ...
                    className="w-full justify-start p-3 hover:bg-sidebar-accent"
                  >
